...
//Fix by NoobMCBG
use Ifera\ScoreHud\task\CheckUpdateTask;
...
╚═╝░░╚══╝░╚════╝░░╚════╝░╚═════╝░╚═╝░░░░░╚═╝░╚════╝░╚═════╝░░╚═════╝░");
		...
		$this->getServer()->getCommandMap()->register("ScoreHud", new ScoreHudCommand($this)); //Fix by NoobMCBG
	}
	...
	public function checkUpdatePlugin(bool $isRetry = false): void {
